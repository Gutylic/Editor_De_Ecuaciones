...
namespace index
{
    public partial class buscar_x_profundidad : System.Web.UI.Page
    {
        ...
        {
            Resultado_DataList.DataSource = LB.Mostrar_Ejercicios_Profundidad(Enunciado).Skip(Pagina * 10).Take(10); // datalist que muestra los enunciados similares de a 10 datos 
        ...
        public void Condiciones_Paginacion()
        {
            ...
            ViewState["Cantidad_De_Datos_Enunciado"] = LB.Contar_Ejercicios_Profundidad((string)ViewState["Enunciado"]); //cantidad de datos al buscar por enunciados
