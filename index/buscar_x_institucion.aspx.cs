...
namespace index
{
    public partial class buscar_x_institucion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Cargar_Variables_De_URL(Request.QueryString["Institucion"]); // carga las variables de la URL                
                Listado_De_Parecidos(Convert.ToInt32(ViewState["Enunciado"]), 0); // Llama al datalist de enunciados parecidos, desde la pagina cero
        ...
        {
            ViewState["Enunciado"] = Enunciado; // recupera desde el URL el Enunciado
        }
        ...
        public void Condiciones_Paginacion()
        {
            ...
            ViewState["Cantidad_De_Datos_Enunciado"] = LB.Contar_Ejercicio_Institucion(Convert.ToInt32(ViewState["Enunciado"])); //cantidad de datos al buscar por enunciados
        ...
        public void Listado_De_Parecidos(int Enunciado, int Pagina)
        {
            Resultado_DataList.DataSource = LB.Mostrar_Ejercicio_Institucion(Enunciado).Skip(Pagina * 10).Take(10); // datalist que muestra los enunciados similares de a 10 datos 
        ...
        protected void Siguiente_Click(object sender, EventArgs e)
        {
            ...
            {
                Listado_De_Parecidos((int)ViewState["Enunciado"], (int)ViewState["Pagina_Enunciado"]); // llama al datalist 
