<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lector.aspx.cs" Inherits="index.lector" ValidateRequest="false" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function Permitir() {
            ...
            var seleccion = document.getElementById("Subir_Ejercicio").value;
        ...
        <div class="row">
            ...
            <div class="col-md-3"   style="margin-top: 80px";>
                ...
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item active">Lector de Archivos</a>
            ...
            <div class="col-md-9">
                 ...
                 <div class="thumbnail" style=" margin-top:60px" >
                    ...
                    <asp:FileUpload ID="Subir_Ejercicio" runat="server" />
                ...
                <div class="thumbnail" style=" margin-top:20px" >
                    ...
                    <div class="caption-full">
                        ...
                        <asp:Button ID="Cargar_Ejercicio" class="btn btn-danger" Width="100%" runat="server"  Text="Cargar Ejercicio" OnClick="Cargar_Ejercicio_Click" OnClientClick="return Permitir()" />           
                    </div>                    
                </div>
...
<table style="width: 100%;">
                            <tr>
                                <td style="width: 33%;font-size:16px; color: rgb(51,122,183); text-align:center">Ubicacion del Ejercicio</td>
                                <td style="width: 34%;font-size:16px; color: rgb(51,122,183); text-align:center"">Ubicacion de la Impresion</td>
                                <td style="width: 33%;font-size:16px; color: rgb(51,122,183); text-align:center"">Ubicacion del Video</td>
                             </tr>
    </table>
    <hr style="margin-top:-10px">
                            <table style="width: 100%;">
                             <tr>
                                <td style="width: 30%; text-align:center"><asp:TextBox ID="Ubicacion_Del_Ejercicio" runat="server" Width="99%" Height="36px" style="margin-left: 0px"></asp:TextBox></td>
                                <td style="width: 30%; text-align:center"><asp:TextBox ID="Ubicacion_De_Impresion" runat="server" Width="99%" Height="36px" style="margin-left: 0px"></asp:TextBox></td>
                                <td style="width: 30%; text-align:center"><asp:TextBox ID="Ubicacion_Del_Video_Y_Explicacion" runat="server" Width="99%" Height="36px" style="margin-left: 0px"></asp:TextBox></td>
