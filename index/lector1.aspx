<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lector1.aspx.cs" Inherits="index.lector1" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function Confirmacion() {
            ...
            var seleccion = confirm("Usted desea actualizar el ejercicio ?");

            if (seleccion)
                alert("El ejercicio fue actualizado correctamente");
            else
                alert("No acepto actualizar el ejercicio");
            ...
            <div class="col-md-9">
               ...
               <h4 style="margin-top:-10px"><a href="#" style="color:rgb(10, 28, 72)">Materia por Sinonimo  </a>
                ...
                <div class="well">
                    ...
                    <asp:Button ID="Actualizar_Ejercicio" class="btn btn-danger" runat="server" Text="Actualizar Ejercicio" OnClick="Actualizar_Ejercicio_Click" OnClientClick="return Confirmacion();" />
